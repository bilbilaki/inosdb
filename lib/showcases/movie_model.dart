...
class Person {
  ...
  String get fullProfilePath => profilePath != null 
      ? 'https://inosdb.worker-inosuke.workers.dev/w500$profilePath': 'https://image.tmdb.org/t/p/w500$profilePath' ;
...
class Cast {
  ...
  String get fullProfilePath => profilePath != null 
      ? 'https://inosdb.worker-inosuke.workers.dev/w200$profilePath': 'https://image.tmdb.org/t/p/w200$profilePath';
...
class MovieCredits {
  ...
  List<Crew> get producers {
    return crew.where((crewMember) => 
      ...
      (crewMember.job == 'Producer' || crewMember.job == 'Executive Producer')
    ).toList();
  }
}
...
class Movie {
  ...
  factory Movie.fromJson(Map<String, dynamic> json) {
    ...
    final bool hasDetails = json.containsKey('runtime') || json.containsKey('genres');
    ...
    return Movie(
      ...
      productionCompanies: json.containsKey('production_companies')
          ? (json['production_companies'] as List?)?.map((company) => ProductionCompany.fromJson(company)).toList()
          : null,
      productionCountries: json.containsKey('production_countries')
          ? (json['production_countries'] as List?)?.map((country) => ProductionCountry.fromJson(country)).toList()
          : null,
      revenue: json['revenue'],
      runtime: json['runtime'],
      spokenLanguages: json.containsKey('spoken_languages')
          ? (json['spoken_languages'] as List?)?.map((language) => SpokenLanguage.fromJson(language)).toList()
          : null,
      status: json['status'],
