...
import 'package:myapp/widgets/anime_series_card.dart'; // Use TvSeriesCard
...
class _SearchScreenAnimeState extends State<SearchScreenAnime> {
  ...
  void dispose() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        Provider.of<AnimeProvider>(context, listen: false).searchTvSeries('');
      }
    });
    super.dispose();
  }
  ...
  void _performSearch(String query) {
    Provider.of<AnimeProvider>(context, listen: false).searchTvSeries(query);
  }
                    ...
                    return MasonryGridView.count(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return AnimeSeriesCard(
                            series: series); // Use TvSeriesCard
                      },
                    );
                  },
                ),
